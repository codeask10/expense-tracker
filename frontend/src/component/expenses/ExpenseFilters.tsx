...
import type { ExpenseFilters, SortBy, SortOrder } from '../../types/expense';
...
export const ExpenseFiltersBar = memo(function ExpenseFiltersBar({ filters, onChange }: ExpenseFiltersProps) {
  return (
